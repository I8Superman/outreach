<template>
    <div class="add-contact view">
        <div class="subpage-icons">
            ...
            <div class="link" @click="console.log('Importing contacts')">
                <img class="icon" src="@/assets/icons/icon-import-contacts.svg" alt="menu-icon-import">
            </div>
            <div class="link" @click="console.log('Adding multiple contacts')">
                <img class="icon" src="@/assets/icons/icon-add-contacts.svg" alt="menu-icon-add-multiple-contacts">
            </div>
        ...
        <h2>Add contact</h2>
        <form class="add-contact-form" @sumbit.prevent="addContact">
